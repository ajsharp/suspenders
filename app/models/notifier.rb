class Notifier < ActionMailer::Base
  ...
  def password_reset_instructions(user)
    subject       "CVBeast Password Reset Instructions"
    from          "CVBeast <noreply@cvbeast.com>"
  ...
  def activation_instructions(user)
    subject       "Please activate your CVBeast account"
    from          "CVBeast <noreply@cvbeast.com>"
    recipients    user.email
    sent_on       Time.now
  ...
  def activation_confirmation(user)
    subject       "CVBeast Activation complete"
    from          "CVBeast <noreply@cvbeast.com>"
    recipients    user.email
    sent_on       Time.now
